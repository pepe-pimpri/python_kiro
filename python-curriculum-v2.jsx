...
import { conceptExplanations } from "./conceptExplanations";
  ...
  const filtered = curriculum
    .map(section => ({
      ...
      topics: section.topics.filter(t =>
        ...
        t.assignments.some(a => a.toLowerCase().includes(search.toLowerCase()))
      )
    }))
    .filter(section =>
      (filter === "ALL" || section.level === filter) &&
  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        <div style={{
          position: "absolute", inset: 0,
          background: "radial-gradient(ellipse 60% 50% at 15% 50%, rgba(74,222,128,0.06) 0%, transparent 100%)",
          pointerEvents: "none",
        }} />
        ...
        <div style={{ position: "relative", maxWidth: "900px" }}>
          <div style={{
            ...
            <span style={{ color: "#4ade80", fontSize: "10px", letterSpacing: "3px" }}>
          ...
          <p style={{
            color: "#52525b", fontSize: "14px", margin: "0 0 36px",
            letterSpacing: "0.5px", lineHeight: "1.6",
          }}>
            Every concept used in real production codebases. No fluff.
          </p>
          ...
          <div style={{ display: "flex", gap: "32px", flexWrap: "wrap" }}>
            {[
              ...
              { label: "Levels", value: curriculum.length },
            ].map(({ label, value }) => (
              <div key={label}>
                <div style={{ fontSize: "28px", fontWeight: "800", color: "#4ade80", letterSpacing: "-1px" }}>{value}</div>
                <div style={{ fontSize: "11px", color: "#3f3f46", letterSpacing: "2px", textTransform: "uppercase" }}>{label}</div>
              </div>
            ))}
          </div>
        </div>
      ...
      <div style={{ padding: "32px 48px 64px", maxWidth: "1100px" }}>
          ...
          <div key={section.level} style={{ marginBottom: "52px" }}>
            ...
            <div style={{ display: "flex", alignItems: "center", gap: "16px", marginBottom: "16px" }}>
              ...
              <span style={{ fontSize: "10px", color: "#27272a" }}>
                ...
                {section.topics.reduce((a, t) => a + t.assignments.length, 0)} assignments
              </span>
            </div>
                  ...
                  >
                    ...
                    >
                      ...
                      <span style={{
                        ...
                        color: isOpen ? "#fff" : "#a1a1aa", letterSpacing: "0.2px",
                      }}>
                        {topic.title}
                      </span>
                        ...
                        <div style={{
                          ...
                          {["concepts", "assignments"].map(tab => (
                            <button
                              ...
                              style={{
                                padding: "10px 20px",
                                background: activeTab === tab ? `${section.color}12` : "transparent",
                                border: "none",
                                borderBottom: activeTab === tab ? `2px solid ${section.color}` : "2px solid transparent",
                          ...
                          {activeTab === "concepts" && (
                            <div style={{
                              ...
                              {topic.concepts.map((c, i) => (
                                <button
                                  key={i}
                                  onClick={() => setSelectedConcept({ text: c, color: section.color, topicTitle: topic.title })}
                                  style={{
                                ...
                                >
                                  ...
                                  <span style={{ color: section.color, opacity: 0.3, fontSize: "10px", flexShrink: 0, marginTop: "2px" }}>⟶ explain</span>
                                </button>
                              ))}
                            </div>
                          )}
        ...
        {filtered.length === 0 && (
          <div style={{
            ...
            color: "#27272a", fontSize: "14px", letterSpacing: "1px",
          }}>
      ...
      <div style={{
        ...
        <span>PYTHON 3.10+ · PRODUCTION READY</span>
      </div>

      {/* Concept Explanation Modal */}
      {selectedConcept && (() => {
        const explanation = conceptExplanations[selectedConcept.text];
        const color = selectedConcept.color;
        return (
          <div
          ...
          >
            ...
            >
              ...
              <div style={{
                ...
                <div>
                  <div style={{ fontSize: "9px", letterSpacing: "3px", color: color, opacity: 0.7, marginBottom: "8px", textTransform: "uppercase" }}>
                    {selectedConcept.topicTitle} — Developmental Explanation
                  </div>
                ...
                <button
                  onClick={() => setSelectedConcept(null)}
                  style={{
                    background: "none", border: `1px solid ${color}30`, borderRadius: "4px",
                    color: color, cursor: "pointer", fontSize: "16px", padding: "4px 10px",
                    flexShrink: 0, lineHeight: 1, fontFamily: "inherit", opacity: 0.7,
                  }}
                >✕</button>
              </div>
              ...
              <div style={{ padding: "28px" }}>
                {explanation ? (
                  <div>
                    ...
                    {explanation.problem && (
                      <div style={{ marginBottom: "22px" }}>
                        <div style={{
                          ...
                          <span style={{ display: "inline-block", width: "20px", height: "1px", background: color, opacity: 0.5 }} />
                          The Problem Being Solved
                        </div>
                        <p style={{ fontSize: "13px", color: "#a1a1aa", lineHeight: "1.9", margin: 0 }}>
                          {explanation.problem}
                        </p>
                      </div>
                    )}
                    ...
                    {explanation.insight && (
                      <div style={{
                        ...
                        <div style={{
                          fontSize: "9px", letterSpacing: "3px", color: color,
                          textTransform: "uppercase", marginBottom: "8px", opacity: 0.8,
                        }}>
                          ✦ The Insight
                        </div>
                        <p style={{ fontSize: "13px", color: "#d4d4d8", lineHeight: "1.9", margin: 0 }}>
                          {explanation.insight}
                        </p>
                      </div>
                    )}
                  ...
                  <p style={{ fontSize: "13px", color: "#52525b", lineHeight: "1.8", fontStyle: "italic" }}>
                    Explanation coming soon for this concept.
                  </p>
                )}
              </div>
            </div>
